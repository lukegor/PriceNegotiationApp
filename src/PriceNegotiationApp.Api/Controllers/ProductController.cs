...
namespace PriceNegotiationApp.Api.Controllers
{
    ...
    public class ProductController(IProductService productService) : ControllerBase
    {
        ...
        {
            var product = await productService.GetProductAsync(new GetProductByIdQuery(id), cancellationToken);
        ...
        {
            var updated = await productService.UpdateProductAsync(request.ToUpdateProductCommand(id), cancellationToken);
        ...
        {
            var dbProduct = await productService.CreateProductAsync(request.ToCreateProductCommand(), cancellationToken);
