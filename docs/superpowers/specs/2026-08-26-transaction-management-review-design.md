...
- Reference: `docs/transaction-management-patterns.md`
...
Verify the codebase actually implements what `transaction-management-patterns.md`
...
- Replace the transplanted closing section of `docs/transaction-management-patterns.md`
