...
{
    public class RequirementsNames
    {
        public const string CreateRequirement = nameof(CreateRequirement);
        public const string ReadRequirement = nameof(ReadRequirement);
