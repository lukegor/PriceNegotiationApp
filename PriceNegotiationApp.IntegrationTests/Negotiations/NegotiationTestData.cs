...
namespace PriceNegotiationApp.IntegrationTests.Negotiations
{
    public class NegotiationTestData
    {
        ...
        private ICollection<Negotiation> GetSampleNegotiations(List<Product> products)
        {
            ...
            {
                _negotiationFactory.Create(products[0].Id, products[0].Price.Value, new ProposedPrice(4.50M), Guid.Parse("00000000-0000-0000-0000-000000000001")),
                _negotiationFactory.Create(products[1].Id, products[1].Price.Value, new ProposedPrice(2.00M), Guid.Parse("00000000-0000-0000-0000-000000000002")),
                _negotiationFactory.Create(products[2].Id, products[2].Price.Value, new ProposedPrice(3.00M), Guid.Parse("00000000-0000-0000-0000-000000000003")),
            };
        }
